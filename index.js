...
Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? " remains" : "s remain"} unfunded. We need your help to fund these amazing games!
`;

// create a new DOM element containing the template string and append it to the description container
const summaryParagraph = document.createElement("p");
summaryParagraph.textContent = summaryString.trim();
...
topGameElement.textContent = first.name;
